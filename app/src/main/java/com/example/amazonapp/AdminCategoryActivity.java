...
public class AdminCategoryActivity extends AppCompatActivity {
    ...
    Button checkOrderButton,checkLogoutButton,maintainButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkLogoutButton = (Button)findViewById(R.id.checkLogoutButton);
        ...
        checkLogoutButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        checkOrderButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(AdminCategoryActivity.this,AdminNewCategoryActivity.class);
                startActivity(i);
            }
        });
